...
var Main = {
	...
	over : function(){
		...
		if(this.level >= 20){
			...
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "社会，社会我大哥，竟然下了<label>"+this.level+"</label>层,神呀！";
			WF.getId("js_end_flush").getElementsByTagName("a")[0].innerHTML = "无敌是多么寂寞";
			WF.getId("js_end_flush").getElementsByTagName("span")[0].className = "icon laughter";
		}
		else if(this.level >= 10 && this.level <20)
		{
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "厉害了，下了<label>"+this.level+"</label>层,男人中的男人呀！";
			WF.getId("js_end_flush").getElementsByTagName("a")[0].innerHTML = "人生巅峰？";
			WF.getId("js_end_flush").getElementsByTagName("span")[0].className = "icon smile";
		}
		else if(this.level >3 && this.level < 10)
		{
			WF.getId("js_end_flush").getElementsByTagName("p")[0].innerHTML = "啧啧,才下了<label>"+this.level+"</label>层,继续努力啊！";
			WF.getId("js_end_flush").getElementsByTagName("a")[0].innerHTML = "想变的更强？";
